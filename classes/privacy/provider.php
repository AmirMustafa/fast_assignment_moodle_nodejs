...
class provider implements
    ...
    public static function get_metadata(collection $collection) : collection {
        ...
        $collection->add_database_table('fastassignment_user_mapping', $assignusermapping, 'privacy:metadata:assignusermapping');
    ...
    public static function get_contexts_for_userid(int $userid) : contextlist {
        ...
        $sql = "SELECT ctx.id
                  ...
                  JOIN {fastassignment} a ON cm.instance = a.id
                  JOIN {context} ctx ON cm.id = ctx.instanceid AND ctx.contextlevel = :contextlevel
                  JOIN {fastassignment_user_mapping} aum ON a.id = aum.assignment
    ...
    public static function get_users_in_context(userlist $userlist) {
        ...
        $sql = "SELECT um.userid
                  ...
                  JOIN {modules} m ON m.id = cm.module AND m.name = :modulename
                  JOIN {fastassignment} a ON a.id = cm.instance
                  JOIN {fastassignment_user_mapping} um ON a.id = um.assignment
                 WHERE ctx.id = :contextid AND ctx.contextlevel = :contextlevel";
        $userlist->add_from_sql('userid', $sql, $params);
    ...
    public static function delete_data_for_all_users_in_context(\context $context) {
        ...
        if ($context->contextlevel == CONTEXT_MODULE) {
            ...
            if ($cm) {
                ...
                $DB->delete_records('fastassignment_user_mapping', ['assignment' => $fastassignment->get_instance()->id]);
            }
        }
    }
    ...
    public static function delete_data_for_user(approved_contextlist $contextlist) {
        ...
        foreach ($contextlist as $context) {
            ...
            $DB->delete_records('fastassignment_user_mapping', ['assignment' => $assignid, 'userid' => $user->id]);
    ...
    public static function delete_data_for_users(approved_userlist $userlist) {
        ...
        $DB->delete_records_select('fastassignment_user_mapping', "assignment = :assignment AND userid $sql", $params);
