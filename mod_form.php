...
class mod_fastassignment_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $PAGE->requires->js( new moodle_url($CFG->wwwroot . "/mod/fastassignment/api.js?v=21") );
        ...
        $mform->addElement('text', 'api_key', get_string('getapikey', 'fastassignment'), array('size' => '64'));
