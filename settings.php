...
if ($ADMIN->fulltree) {
    ...
    // $description = new lang_string('apikey_help', 'mod_fastassignment');
    $description = "Please enter your API key. This API key is used for fetching test's description when admin/teacher creates the new Fast Assignment activity.";
    $default = "6a7edc3e-6cfa-11e7-97aa-00224d567b10";
    $setting = new admin_setting_configtextarea('fastassignment/apikey',
        $name,
        $description,
        $default);
