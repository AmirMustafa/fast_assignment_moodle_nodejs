@mod @mod_fastassignment @fastassignfeedback @fastassignfeedback_editpdf @_file_upload
Feature: In an assignment, teacher can view the feedback for a previous attempt.
  ...
  Scenario: Submit a PDF file as a student and annotate the PDF as a teacher, allowing another attempt
    ...
    And I upload "mod/fastassignment/feedback/editpdf/tests/fixtures/submission.pdf" file to "File submissions" filemanager
    And I upload "mod/fastassignment/feedback/editpdf/tests/fixtures/testgs.pdf" file to "File submissions" filemanager
