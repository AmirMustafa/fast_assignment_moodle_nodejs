 ...
 */
function xmldb_fastassignfeedback_editpdf_install() {
    global $CFG;
    ...
    $filerecord->component = 'fastassignfeedback_editpdf';
    ...
    foreach ($defaultstamps as $stamp) {
        ...
        $fs->create_file_from_pathname($filerecord,
            $CFG->dirroot . '/mod/fastassignment/feedback/editpdf/pix/' . $filerecord->filename);
    }
}
