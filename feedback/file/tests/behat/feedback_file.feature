@mod @mod_fastassignment @fastassignfeedback @fastassignfeedback_file @_file_upload
Feature: In an assignment, teacher can submit feedback files during grading
  ...
  Background:
    ...
    And I set the field "fastassignfeedback_file_enabled" to "1"
    ...
    And I upload "mod/fastassignment/feedback/file/tests/fixtures/submission.txt" file to "File submissions" filemanager
    ...
    And I upload "mod/fastassignment/feedback/file/tests/fixtures/feedback.txt" file to "Feedback files" filemanager
