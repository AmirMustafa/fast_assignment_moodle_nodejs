...
/**
 * The fastassignsubmission_file assessable uploaded event.
 *
...
/**
 * The fastassignsubmission_file assessable uploaded event class.
 *
 * @package    fastassignsubmission_file
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'fastassignsubmission_file');
    }
    ...
    protected function init() {
        parent::init();
        $this->data['objecttable'] = 'fastassignment_submission';
    }

    public static function get_objectid_mapping() {
        return array('db' => 'fastassignment_submission', 'restore' => 'submission');
    }
}
