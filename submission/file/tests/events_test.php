...
class fastassignsubmission_file_events_testcase extends advanced_testcase {
    ...
    public function test_assessable_uploaded() {
        ...
        $files = $fs->get_area_files($context->id, 'fastassignsubmission_file', FASTASSIGNSUBMISSION_FILE_FILEAREA,
        ...
        $event = reset($events);
        $this->assertInstanceOf('\fastassignsubmission_file\event\assessable_uploaded', $event);
        ...
        $expected->modulename = 'fastassignment';
        $expected->cmid = $cm->id;
    ...
    public function test_submission_created() {
        ...
        $event = $events[1];
        $this->assertInstanceOf('\fastassignsubmission_file\event\submission_created', $event);
        $this->assertEquals($context->id, $event->contextid);
    ...
    public function test_submission_updated() {
        ...
        // We want to test the last event fired.
        $event = $events[3];
        $this->assertInstanceOf('\fastassignsubmission_file\event\submission_updated', $event);
        $this->assertEquals($context->id, $event->contextid);
        $this->assertEquals($course->id, $event->courseid);
        $this->assertEquals($submission->id, $event->other['submissionid']);
        $this->assertEquals($submission->attemptnumber, $event->other['submissionattempt']);
