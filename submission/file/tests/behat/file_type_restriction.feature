@mod @mod_fastassignment @fastassignsubmission_file
Feature: In an assignment, limit submittable file types
  ...
  Background:
    ...
    And the following config values are set as admin:
      | filetypes | image/png;spreadsheet | fastassignsubmission_file |

  @javascript
  Scenario: File types validation for an assignment
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | duedate    | fastassignsubmission_onlinetext_enabled | fastassignsubmission_file_enabled | fastassignsubmission_file_maxfiles | fastassignsubmission_file_maxsizebytes |
      | fastassignment   | C1     | assign1  | Test assignment name | Test assignment description | 1388534400 | 0                                   | 1                             | 1                              | 0                                  |
  ...
  Scenario: Uploading permitted file types for an assignment
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | duedate    | fastassignsubmission_onlinetext_enabled | fastassignsubmission_file_enabled | fastassignsubmission_file_maxfiles | fastassignsubmission_file_maxsizebytes | fastassignsubmission_file_filetypes |
      | fastassignment   | C1     | assign1  | Test assignment name | Test assignment description | 1388534400 | 0                                   | 1                             | 3                              | 0                                  | image/png,spreadsheet,.xml,.txt  |
  ...
  Scenario: No filetypes allows all
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | duedate    | fastassignsubmission_onlinetext_enabled | fastassignsubmission_file_enabled | fastassignsubmission_file_maxfiles | fastassignsubmission_file_maxsizebytes | fastassignsubmission_file_filetypes |
      | fastassignment   | C1     | assign1  | Test assignment name | Test assignment description | 1388534400 | 0                                   | 1                             | 2                              | 0                                  |                                 |
    And I log in as "student1"
    And I am on "Course 1" course homepage
    And I follow "Test assignment name"
    When I press "Add submission"
