 ...
 * needed to restore one fastassignment_submission subplugin.
 *
 * @package fastassignsubmission_file
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_fastassignsubmission_file_subplugin extends restore_subplugin {
     ...
     * @return void
     */
    public function process_fastassignsubmission_file_submission($data) {
        global $DB;
        ...
        $DB->insert_record('fastassignsubmission_file', $data);

        $this->add_related_files('fastassignsubmission_file',
                                 'submission_files',
                                 'submission',
                                 null,
                                 $oldsubmissionid);
