...
/**
 * Strings for component 'fastassignment', language 'en'
 *
...
$string['fastassignment:addinstance'] = 'Add a new assignment';
$string['fastassignment:exportownsubmission'] = 'Export own submission';
$string['fastassignment:editothersubmission'] = 'Edit another student\'s submission';
$string['fastassignment:grade'] = 'Grade assignment';
$string['fastassignment:grantextension'] = 'Grant extension';
$string['fastassignment:manageallocations'] = 'Manage markers allocated to submissions';
$string['fastassignment:managegrades'] = 'Review and release grades';
$string['fastassignment:manageoverrides'] = 'Manage assignment overrides';
$string['fastassignment:receivegradernotifications'] = 'Receive grader submission notifications';
$string['fastassignment:releasegrades'] = 'Release grades';
$string['fastassignment:revealidentities'] = 'Reveal student identities';
$string['fastassignment:reviewgrades'] = 'Review grades';
$string['fastassignment:viewblinddetails'] = 'View student identities when blind marking is enabled';
$string['fastassignment:viewgrades'] = 'View grades';
$string['fastassignment:showhiddengrader'] = 'See the identity of a hidden grader';
$string['fastassignment:submit'] = 'Submit assignment';
$string['fastassignment:view'] = 'View assignment';
$string['fastassignfeedback'] = 'Feedback plugin';
$string['fastassignfeedbackpluginname'] = 'Feedback plugin';
$string['assignmentisdue'] = 'Fast Assignment is due';
...
$string['assignmentname'] = 'Fast Assignment name';
$string['assignmentplugins'] = 'Fast Assignment plugins';
$string['assignmentsperpage'] = 'Fast Assignments per page';
$string['fastassignsubmission'] = 'Submission plugin';
$string['fastassignsubmissionpluginname'] = 'Submission plugin';
...
$string['downloadasfolders_help'] = 'Fast Assignment submissions may be downloaded in folders. Each submission is then put in a separate folder, with the folder structure kept for any subfolders, and files are not renamed.';
...
$string['eventoverridecreated'] = 'Fast Assignment override created';
$string['eventoverridedeleted'] = 'Fast Assignment override deleted';
$string['eventoverrideupdated'] = 'Fast Assignment override updated';
...
$string['indicator:cognitivedepth'] = 'Fast Assignment cognitive';
...
$string['indicator:cognitivedepthdef'] = 'Fast Assignment cognitive';
...
$string['indicator:socialbreadth'] = 'Fast Assignment social';
...
$string['indicator:socialbreadthdef'] = 'Fast Assignment social';
...
$string['managefastassignfeedbackplugins'] = 'Manage assignment feedback plugins';
$string['managefastassignsubmissionplugins'] = 'Manage assignment submission plugins';
...
$string['messageprovider:fastassignment_notification'] = 'Fast Assignment notifications';
$string['modulename'] = 'Fast Assignment';
...
$string['modulenameplural'] = 'Fast Assignments';
...
$string['newsubmissions'] = 'Fast Assignments submitted';
...
$string['overridegroupeventname'] = '{$a->fastassignment} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overrideuser'] = 'Override user';
$string['overrideusereventname'] = '{$a->fastassignment} - Override';
$string['outlinegrade'] = 'Grade: {$a}';
$string['page-mod-fastassignment-x'] = 'Any assignment module page';
$string['page-mod-fastassignment-view'] = 'Fast Assignment module main and submission page';
$string['paramtimeremaining'] = '{$a} remaining';
$string['participant'] = 'Participant';
$string['pluginadministration'] = 'Fast Assignment administration';
$string['pluginname'] = 'Fast Assignment';
...
$string['privacy:metadata:fastassignfeedbackpluginsummary'] = 'Feedback data for the assignment.';
...
$string['privacy:metadata:assignmarkerfilter'] = 'Filter the fastassignment summary by the assigned marker.';
$string['privacy:metadata:assignmentid'] = 'Fast Assignment ID';
...
$string['privacy:metadata:fastassignsubmissiondetail'] = 'Stores user submission information';
$string['privacy:metadata:fastassignsubmissionpluginsummary'] = 'Submission data for the assignment.';
...
$string['quickgrading_help'] = 'Quick grading allows you to fastassignment grades (and outcomes) directly in the submissions table. Quick grading is not compatible with advanced grading and is not recommended when there are multiple markers.';
...
$string['scale'] = 'Scale';
$string['search:activity'] = 'Fast Assignment - activity information';
...
$string['settings'] = 'Fast Assignment settings';
...
$string['submissionstatement_help'] = 'Fast Assignment submission confirmation statement';
...
$string['submittedearly'] = 'Fast Assignment was submitted {$a} early';
$string['submittedlate'] = 'Fast Assignment was submitted {$a} late';
$string['submittedlateshort'] = '{$a} late';
$string['submitted'] = 'Submitted';
$string['subpagetitle'] = '{$a->contextname} - {$a->subpage}';
$string['subplugintype_fastassignsubmission'] = 'Submission plugin';
$string['subplugintype_fastassignsubmission_plural'] = 'Submission plugins';
$string['subplugintype_fastassignfeedback'] = 'Feedback plugin';
$string['subplugintype_fastassignfeedback_plural'] = 'Feedback plugins';
...
$string['textinstructions'] = 'Fast Assignment instructions';
...
// Add on strings for Fast Assigment  Strings
$string['fastassignmentname'] = 'Assignment name';
$string['fastassignmentquestion'] = 'Description';

$string['apiposturl'] = 'API post URL';
$string['apiposturl_help'] = 'API post URL  is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.';
$string['getapikey'] = '<a href="https://virtualwritingtutor.com/essay-check-api">API key</a>';
$string['getapikey_help'] = '<a href="https://virtualwritingtutor.com/essay-check-api">Get API key </a> by clicking the link <a href="https://virtualwritingtutor.com/essay-check-api">here</a>. CLick on API key from the first header followed by clicking register for an API key link. You will receive your copy of API key in mail. ';
$string['validateapibutton'] = 'Validate';
$string['apikey'] = 'API key';
$string['category'] = 'Evaluation Selector';
$string['category_help'] = 'Select your task type from the category';
$string['test'] = '';
$string['test_help'] = 'Select your test type from the category';
$string['add_to_editor'] = 'Add';
$string['add_to_editor_help'] = 'Add the test type description';

$string['automatedgrammarcheck'] = 'Automated Grammar Check';
$string['maxnoofchecks'] = 'Maximum no of checks';
$string['studentaccessibleautoeval'] = 'Student-accessible automated evaluation';
$string['maxnoofchecksstudent'] = 'Maximum no of checks';
$string['teacheraccessibleautoeval'] = 'Teacher-accessible automated evaluation';
$string['maxnoofchecksteacher'] = 'Maximum no of checks';
$string['api_key_feedback'] = 'Maximum no of checks';
$string['api_key_feedback_help'] = 'Feedback help is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.';
$string['apiposturl_feedback'] = 'Grammar check API post url';
$string['api_post_url_help'] = 'API post url is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.';
$string['automatedevaluation'] = 'Automated evaluation';
$string['grammarcheck'] = 'Grammar check';